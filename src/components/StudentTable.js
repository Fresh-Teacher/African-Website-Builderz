          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {students.map((student, index) => (
              ...
              >
                ...
                <td className="px-4 py-4">
                  <div className="text-sm text-gray-900">{student["WhatsApp number"]}</div>
                </td>
                <td className="px-4 py-4">
                  <div className="text-sm text-gray-900">{student["Email Address"]}</div>
                </td>
              </tr>
            ))}
          </tbody>
                  ...
                  <div>
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between text-sm mb-1">
                        ...
                        <span>{getProgressPercentage(selectedStudent.courseProgress)}%</span>
                      </div>
